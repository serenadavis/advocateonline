...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Content.publishDate'
        db.add_column(u'magazine_content', 'publishDate',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Content.publishDate'
        db.delete_column(u'magazine_content', 'publishDate')
    ...
    models = {
        ...
        u'magazine.content': {
            ...
            'publishDate': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow', 'blank': 'True'}),
