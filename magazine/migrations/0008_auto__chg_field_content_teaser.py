...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Content.teaser'
        db.alter_column(u'magazine_content', 'teaser', self.gf('tinymce.models.HTMLField')())

    def backwards(self, orm):

        # Changing field 'Content.teaser'
        db.alter_column(u'magazine_content', 'teaser', self.gf('django.db.models.fields.TextField')())
