...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Contributor', fields ['name']
        db.create_unique(u'magazine_contributor', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Contributor', fields ['name']
        db.delete_unique(u'magazine_contributor', ['name'])
