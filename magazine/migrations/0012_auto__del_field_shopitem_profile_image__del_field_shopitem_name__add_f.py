...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShopItem.profile_image'
        db.delete_column(u'magazine_shopitem', 'profile_image')

        # Deleting field 'ShopItem.name'
        db.delete_column(u'magazine_shopitem', 'name')

        # Adding field 'ShopItem.title'
        db.add_column(u'magazine_shopitem', 'title',
                      self.gf('django.db.models.fields.CharField')(default='no title', max_length=255),
                      keep_default=False)

        # Adding field 'ShopItem.image'
        db.add_column(u'magazine_shopitem', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'ShopItem.price'
        db.alter_column(u'magazine_shopitem', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):
        # Adding field 'ShopItem.profile_image'
        db.add_column(u'magazine_shopitem', 'profile_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ShopItem.name'
        db.add_column(u'magazine_shopitem', 'name',
                      self.gf('django.db.models.fields.CharField')(default='hello', max_length=255),
                      keep_default=False)

        # Deleting field 'ShopItem.title'
        db.delete_column(u'magazine_shopitem', 'title')

        # Deleting field 'ShopItem.image'
        db.delete_column(u'magazine_shopitem', 'image')


        # Changing field 'ShopItem.price'
        db.alter_column(u'magazine_shopitem', 'price', self.gf('django.db.models.fields.CharField')(max_length=255))
